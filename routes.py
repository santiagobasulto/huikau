...
routes = [
    ...
    webapp2.Route(r'/image-ad/<img_advert_id:\d+>', handler='handlers.image.ImageAdvertServer',name='image-server',methods=['GET']),
    PathPrefixRoute('/api', [
        webapp2.Route(r'/random/campaign_id:<campaign_id:\d+>/type:<type:\w+>', handler='handlers.api.Random',methods=['GET']),
        webapp2.Route(r'/random-image/campaign_id:<campaign_id:\d+>', handler='handlers.api.Random',defaults={'type':'image'},methods=['GET']),
        webapp2.Route(r'/random-text/campaign_id:<campaign_id:\d+>', handler='handlers.api.Random',defaults={'type':'text'},methods=['GET']),
        #webapp2.Route(r'/login', handler='handlers.users.LoginHandler',name='login',methods=['GET']),
    ]),
    webapp2.Route(r'/json-test', handler='handlers.views.json_test',methods=['GET']),      
